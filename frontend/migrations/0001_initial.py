    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(related_name='user_settings', to='stringprint.Organisation',on_delete=models.CASCADE)),
                ('user', models.ForeignKey(related_name='settings', to=settings.AUTH_USER_MODEL,on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
