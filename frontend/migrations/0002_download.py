    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to=frontend.models.org_download_path, blank=True)),
                ('time_requested', models.DateTimeField(auto_now_add=True)),
                ('time_completed', models.DateTimeField(null=True, blank=True)),
                ('downloads', models.IntegerField(default=0)),
                ('article', models.ForeignKey(related_name='downloads', to='stringprint.Article',on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
